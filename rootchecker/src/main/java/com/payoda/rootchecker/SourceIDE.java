 ...
 */
public class SourceIDE {

    private final Context mContext;
    private boolean loggingEnabled = true;

    public SourceIDE(Context context) {
        mContext = context;
    }
    ...
    public boolean isSource() {
        ...
        return detectRootManagementApps() || detectPotentiallyDangerousApps() || checkForBinary("su")
                ...
                || detectTestKeys() || checkSuExists() || checkForSourceNative() || checkForMagiskBinary();
    }
    ...
    public boolean checkForNativeLibraryReadAccess() {
        SourceIDENative sourceIdeNative = new SourceIDENative();
        try {
            sourceIdeNative.setLogDebugMessages(loggingEnabled);
            return true;
    ...
    public boolean canLoadNativeLibrary() {
        return new SourceIDENative().wasNativeLibraryLoaded();
    }
     ...
     */
    public boolean checkForSourceNative() {
        ...
        try {
            sourceIdeNative.setLogDebugMessages(loggingEnabled);
            return sourceIdeNative.checkForSource(paths) > 0;
        } catch (UnsatisfiedLinkError e) {
            return false;
        }
    }
